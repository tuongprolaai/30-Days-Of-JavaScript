...
const array5Number = [1, 2, 3, 4, 5, 6, 7];
...
const mixedDataTypes = ["Tuong", 24, true, [1, 2, 3]];
...
const result = [];
if (itCompanies[0] && itCompanies[0]?.toLowerCase().split("o").length > 2)
    result.push(itCompanies[0]);
if (itCompanies[1] && itCompanies[1]?.toLowerCase().split("o").length > 2)
    result.push(itCompanies[1]);
if (itCompanies[2] && itCompanies[2]?.toLowerCase().split("o").length > 2)
    result.push(itCompanies[2]);
if (itCompanies[3] && itCompanies[3]?.toLowerCase().split("o").length > 2)
    result.push(itCompanies[3]);
if (itCompanies[4] && itCompanies[4]?.toLowerCase().split("o").length > 2)
    result.push(itCompanies[4]);
if (itCompanies[5] && itCompanies[5]?.toLowerCase().split("o").length > 2)
    result.push(itCompanies[5]);
if (itCompanies[6] && itCompanies[6]?.toLowerCase().split("o").length > 2)
...
const words = text.replace(/[\p{P}]/gu, "").split(" ");
console.log(words);
