...
var countries = ['Finland', 'Estonia', 'Sweden', 'Denmark', 'Norway'];
var rectangle = {
    width: 20,
    height: 10,
    area: 200,
...
var e = constants[0], pi = constants[1], gravity = constants[2], humanBodyTemp = constants[3], waterBoilingTemp = constants[4];
// 2. Destructure and assign the elements of countries array to fin, est, sw, den, nor
var fin = countries[0], est = countries[1], sw = countries[2], den = countries[3], nor = countries[4];
// 3. Destructure the rectangle object by its properties or keys.
var width = rectangle.width, height = rectangle.height, area = rectangle.area, perimeter = rectangle.perimeter;
// Exercises: Level 2
...
countrieS.forEach(function (_a) {
    var name = _a.name, capital = _a.capital, population = _a.population, languages = _a.languages;
    console.log("Country: ".concat(name));
    console.log("Capital: ".concat(capital));
    console.log("Population: ".concat(population));
...
function convertArrayToObject(students) {
    return students.map(function (_a) {
        var name = _a[0], skills = _a[1], scores = _a[2];
        return ({
